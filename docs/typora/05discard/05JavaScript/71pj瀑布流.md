...
<script src="js/unserscore.js"></script>
...
function waterFull(parent,child){
    ...
    //1.5父盒子居中
    $(parent).style.width = cols * boxWidth +'px';//感觉少加了一个15px
